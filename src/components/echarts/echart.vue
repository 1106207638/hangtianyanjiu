...
export default {
    ...
    return {
      ...
      activity3: [
        ...
        },
        {
          ...
          category: "相控阵雷达",
          position:
            "阿拉斯加州克利尔航空站格陵兰岛图勒空军基地英国菲林代尔斯皇家航空站",
          count: "3",
          country: "美国",
        ...
        {
          name:
            "“干草堆”超宽带卫星成像雷达(HUSIR):;“干草堆”辅助雷达(HAX);磨石山雷X2",
          category: "机械雷达",
          position: "马萨诸塞州韦斯托弗",
          count: "4",
          country: "美国",
        ...
        {
          name:
            "高级研究计划局林肯C频段观测雷达(ALCOR):高级研究计划局远程跟踪与测量雷达(ALTAIR); 毫米波雷达(MMW);目标分辨和识别实验雷达(TRADEX)",
          category: "机械雷达",
          position: "马绍尔群岛夸贾林环礁",
          count: "4",
        ...
        {
          name:
            "毛伊光学系统(AMOS); 毛伊光学跟踪识别设施(MOTIF);毛伊高级光电系统(AEOS)",
          category: "地基光电",
          position: "夏威夷毛伊岛",
          count: "5",
          ...
          child: [
            {
              time: "2014.4.22至4.26",
              company:
                "46人，澳大利亚、加拿大、法国、德国、英国和美国与演习，日本作为观察国。",
              scene: "",
              target:
                "确定提高盟国太空作战中心之间的合作水平和互操作性，能否改善各自和联合的太空态势感知能力对作战的支持能力。",
            },
            {
              time: "2015.10.26至10.30",
              company:
                "52人，澳大利亚、加拿大、法国、德国、英国、和美国参与演习，日本正式参与演习。",
              scene: "",
              target:
                "确定提高盟国太空作战中心之间的合作水平和互操作性，能否改善各自和联合的太空态势感知能力对作战的支持能力。",
            },
            {
              time: "2016.9.21至9.30",
              company:
                "澳大利亚、加拿大、法国、德国、日本 、英国和商业实体参与学习，意大利作为观察国。",
              scene: "",
              target:
                "确定提高盟国太空作战中心之间的合作水平和互操作性，能否改善各自和联合的太空态势感知能力对作战的支持能力。",
            },
            {
              time: "2017.9.20至9.29",
              company:
                "英国、日本、法国、德国、美国、澳大利亚、加拿大、以及商业实体参与演习，意大利正式参与演习，西班牙和韩国作为观察国。",
              scene: "",
              target:
                "对盟国太空态势感知装备进行一体化指挥与控制测试，改善太空态势感知能力，谋求共同太空安全。",
            },
            {
              time: "2017.9.20至9.29",
              company:
          ...
          child: [
            {
              ...
              target:
                "研究太空控制和从太空使用武力所需条件，反击敌方先进太空能力的手段，评估敌方可能采取的阻碍美国及其盟国使用太空资源的方法。",
            },
            {
              time: "2003.2.20至2.27",
              company:
                "约300多名军民航天专家。除空烟外，还有陆军、NASA、运输部等30多个机构参演。学习还邀请了商业卫星通信与图像供应商 参与。加拿大、英国和澳大利亚派员参加",
              scene: "2017年，与主要战略对手夺取太空控制权",
              target:
                "检验太空系统在未来军事行动中的作用，探索将太空能力整合到联合作战中，模拟验证“太空控制”等概念。",
            },
            {
              time: "2005.2.5至2.11",
              company:
                "约350人。美国所有军种都参与其中，还包括NASA、运输部等30多个机构参演。学习还少年方世玉了商业卫星通信与图像供应商参与。加拿大、英国和澳大利亚派员参加",
              scene:
                "2020年，全球范围内多个地区出现多起冲突，竞争对手既有恐怖分子又有国家行为者。",
              target: "探讨在战争中使用太空技术和新型装备支援联合作战。",
            },
            {
              time: "2007.3.25至9.29",
              company:
                "约400名航天专业人员，他们来自美国防部多家机构、多家非国防部机构。英国、加拿大、澳大利亚派员参加",
              scene: "2025年，全球性作战环境",
              target:
                "验证21世纪联合部队可用的太空能力、战术和技术，检验部队组织机构，促进太空政策和交战规则发展。",
            },
            {
              time: "2009.3.14至3.20",
              company:
                "美国多家政府部门、作战部门的想着人员； 美国盟友澳大利亚、加拿大、英国也派员参与",
              scene:
                "2019年，在一次地区冲突中，美军及其盟军参战，战场空间内，多处太空能力与赛博能力遭到攻击，拒绝服务",
              target:
                "检验国家政策的执行措施，提高太空对抗态势下的决策能力，探索美军与商业部门、盟国及伙伴的协调方法，首次探索太空与赛博的结合。",
            },
            {
              time: "2010.5.7至5.13",
              company:
                "约550名军民航天专家。他们来自美国、澳大利亚、加拿大以及英国的30个机构。若加上支持性工作人员，则共约600人参与",
              scene:
                "2022年，一个地区级对手对美国太空与赛博电子太空系统进行毁灭性打击",
              target:
                "研究太空与赛博能力集成，探索太空与赛博空间对未来威慑战略的贡献，研究联盟太空作战构想，探索一体化的规划程序，保护并实施太空与赛博空间领域的作战行动。",
            },
            {
              time: "2012.4.20至4.26",
              company:
                "约270名军民航天专家。他们来自全美30多个机构以及澳大利亚和北约国家。盟国包括澳大利亚、加拿大和英国；法德意、丹麦、希腊、荷兰和土耳其首次参加",
              scene: "2023年，北约和澳大利亚在非洲对抗海盗联合行动",
              target:
                "探索如何利用太空为多国部队军事行动提供支持；检验太空与赛博空间防御一体化作战。",
            },
            {
              time: "?至2015.2",
              company:
                "约175名军民航天专家，他们来自美国各地政府机构以及澳大利亚、加拿大和英国",
              scene: "2026年，中国“反介入/区域拒止”作战",
              target:
                "探索并评估未来体系机构在拥挤、降效以及军事行动受限环境下的弹性，确定未来体系结构中的作战过程、作战概念以及战术、技术和程序的发展机遇，提高 国家太空防御能力，研究未来的“反介入/区域拒止”（A2/AD）力量体系对空军作战和服务需求的影响。",
            },
            {
              time: "2015.12.11至12.17",
              company:
                "约200名军民航天专家他们来自美国27个机构以及澳大利亚、加拿大、新西兰和英国",
              scene:
                "2025年，美国竞争对手在赛博空间和太空领域具备势均力敌的能力，试图通过利用这些领域实现其战略目标",
              target:
                "识别如何增加太空弹性，包括情报机构、非军事机构、商业机构和盟友；探究如何更好地支持军事联合行动；探索如何对未来能力加以应用，保护多作战域冲突下的太空设施。",
            },
            {
              time: "2016.5.19至5.26",
              company: "约200名军民航天专家他们来自超过7个美国司令部和机构",
              scene:
                "2026年，美甲竞争对手在赛博空间和太空领域具备势均力敌的能力，试图通过利用这些领域实现其战略目标",
              target:
                "确定增强太空弹性的方法；探索如何为作战人员提供优化的八点效能，以支持聪明作战，评估如何在多领域冲突中利用未来能力保护太空事业体系。",
            },
            {
              time: "2017.10.13至10.21",
              company:
                "约200名军民航天专家他们来自美国的27个机构以及澳大利亚、加拿大、新西兰和英国",
              scene:
                "2027年，美国竞争对手在赛博空间和太空领域具备势均力敌的能力，试图通过利用这些领域实现其战略目标",
              target:
                "检验各种联合指挥与控制框架，部署并保护空中、太空和赛博空间能力，支持全球和区域性作战行动； 通过整合“太空作战架构”，深入了解太空弹性、太空威慑和太空作战；探索太空和赛博空间在多域冲突中的作用； 以政府总动员的方式发展伙伴关系，实施联合、联盟作战。",
            },
            {
              time: "2018.10.11至10.19",
              company:
                "共350人。美空军航天怀念部、国家侦察办公室、展柜、商务部等27家机构参演，英法德、澳大利亚、加拿大和新西兰派员参加，日本首次参演",
              scene:
                "2028年，美军印主怀念部辖区内某大国，利用太空与赛博空间力量，攻击美国军用、民用太空系统，冲突范围逐步扩展到全球",
              target:
                "利用盟友力量慑止对手将冲突延伸至太空；盟友参与太空与赛博空间作战行动后的弹性、威慑及作战能力情况； 探索综合指挥与控制框架，利用并防护空天、赛博能力，支持全球及区域作战；确定太空与赛博空间在多域冲突中的战略、战术运用； 利用军、民、商、盟友的伙伴关系遂行一体化太空与赛博作战。",
            },
          ],
        },
        {
          ...
          child: [
            {
              ...
              scene: "",
              target:
                "在竞争、降效和作战有限的领域中实现作战优势，发展太空系统维护和操作所需的作战技能以及战术、技术和程序（TTP",
            },
            {
              time: "2017（具体时间不详）至8.25",
              company:
                "国家太空防御中心、联合太空作战中心、第50和第460太空联队（蓝方）、第527和第26太空入侵者中队（红方）、第50作战大队、第50网络作战大队、第460作战大队和第310作战大队（受训单位）",
              scene: "",
              target:
                "在竞争、降效和作战有限的领域中实现作战优势，发展太空系统维护和操作所需的作战技能以及战术、技术和程序（TTP）",
            },
      ...
      satelliteData: [
        ...
        },
        {
          ...
          country: "中国",
          content:
            '<h2>基本介绍</h2><p>肯尼迪航天中心（Kennedy Space Center，缩写KSC）位于美国东部佛罗里达州东海岩的梅里特岛，成立于1962年7月，是美国国家航空航天局（NASA, Nationa Aeronautics and Spce Administration）进行载人与不载人航天器测试、准备和实施发射的最重要场所，为纪念已故美国总统约翰.肯尼迪（John F.Kennedy）而得名。地理坐标：28°35°\'28.31° 北纬80°90\'03.48\'\'西经。</p><p>2020年11月9日，据美联社报道，美国宇航局（NASA）和美国太空探索技术公司（SpaceX）计划于11月14日执行首次商业载人航天任务。当地时间11月8日，4名宇航员已抵达肯尼迪航天中心。</p><h2>基地组成</h2><p>肯尼迪航天中心由四个部分组成，工业区、39号发射中心和它的两个发射场LC-39和LC-38B、飞行器组装建筑物和参观者中心。</p><h2>发射中心</h2><p>工作区由装配车间、控制中心、气象中心、新闻工作区组成。控制中心是发射的神经枢纽，气象中心负责提供实时的卫星气象云图、风速等数据，供控制中心参考。装配车间则负责 装配火箭或航天飞机，装配完成后，由履带车拖到发射架上。发射架位于距离工作区3公里之外的大西洋畔，两座发射塔分别标号“A”和"B". 美国联合通讯社、路透社、CNN等一些世界主要媒 体在航天中心设有专职记者，并拥有自己的工作楼。工作楼的一层供文字记者使用，二楼平台则供摄影记者拍摄使用。此外每逢重大新闻事件，很多电视媒体和文字媒体会租用卫星工作车，进行现场报道。</p><p style="text-align: center;"><img src="http://192.168.1.27:8080/img/details.1c8ff7a9.jpg" alt="" width="30%"><img src="http://192.168.1.27:8080/img/details.1c8ff7a9.jpg" alt="" width="30%"><img src="http://192.168.1.27:8080/img/details.1c8ff7a9.jpg" alt="" width="30%"></p>',
        },
        {
          name: "基辅",
      ...
      pies: [
        ...
        {
          name:
            "截至 2019 年底国外军用对地观测卫星在轨数量(按卫星所属国家统计)",
          color: [
            "rgba(255, 162, 109, 1)",
            "rgba(0, 121, 254, 1)",
            "rgba(255, 180, 175, 1)",
  ...
  methods: {
      ...
      manoeuvre().then((data) => {
        ...
        if (typeof window.navigator.msSaveBlob !== "undefined") {
          window.navigator.msSaveBlob(
            new Blob([datas], { type: "application/vnd.ms-excel" }),
            "太空战略演习导入模板.xls"
          );
        } else {
    ...
    tableBoxYes3() {
      if (this.isEdit) {
        this.activity2[this.exercise - 1].child[
          this.activeIndex
        ] = this.tableForm3;
      } else {
...
table {
  text-align: center;
  border: 1px solid rgba(10, 71, 135, 0.4);
}
...
.line:before,
.line:after,
.equipmentItem .box:before,
.equipmentItem .box:after {
  position: absolute;
  content: "";
  clear: both;
  width: 21px;
...
table tr:first-child {
  background: rgba(10, 71, 135, 0.4);
  height: 38px;
}

table td {
  padding: 10px;
  border: 2px solid rgba(10, 71, 135, 0.6);
  border-right: none;
  border-top: none;
}
...
.garbage .centerRegion .left .leftItem:nth-child(2),
.garbage .centerRegion .left .leftItem:nth-child(4),
.garbage .centerRegion .left .leftItem:nth-child(5),
.garbage .centerRegion .left .leftItem:nth-child(7) {
  background: none;
}
